...
//  *
//  */
// public class AutonomousTrajectoryCommand extends CommandBase {
...
//     public AutonomousTrajectoryCommand(Trajectory trajectory, DrivetrainSubsystem drivetrainSubsystem) {
...
//         super(trajectory.getDuration());
//         requires(RobotContainer.m_drivetrainSubsystem);
...
//         RobotContainer.m_drivetrainSubsystem.getGyroscope().setAdjustmentAngle(Robot.drivetrainSubsystem.getGyroscope().getUnadjustedAngle());
...
//         RobotContainer.m_drivetrainSubsystem.resetKinematics(position, 0);


//         RobotContainer.m_drivetrainSubsystem.getFollower().follow(autonomousTrajectory);
...
//     protected void end() {
//         RobotContainer.m_drivetrainSubsystem.holonomicDrive(Vector2.ZERO, 0.0, true);
//     }
